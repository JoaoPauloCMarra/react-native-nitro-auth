...
- Android decodes Microsoft ID token claims from UTF-8 bytes without passing
  decoded payloads through JNI strings. Unicode claims remain intact, and
  malformed UTF-8 claims are rejected.
